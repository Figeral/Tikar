...
class AssetModal extends StatefulWidget {
  final double width, height;
  const AssetModal({super.key, required this.width, required this.height});

  @override
  State<AssetModal> createState() => _AssetModalState();
}

class _AssetModalState extends State<AssetModal> {
